...
public class NewsDetailsActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener{
    ...
    private boolean isHideTooBarView = false;
    ...
    public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
        ...
        if (percentage == 1f && isHideTooBarView){
            date_behavior.setVisibility(View.GONE);
            titleAppbar.setVisibility(View.VISIBLE);
            isHideTooBarView = !isHideTooBarView;
        }

        else if (percentage < 1f && isHideTooBarView){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.webView){
            ...
            try {
                ...
                Toast.makeText(this, "Can not be shared, there is some error.", Toast.LENGTH_SHORT).show();
            }
        }
